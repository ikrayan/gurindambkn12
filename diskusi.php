...
?>
	...
	while ($d = mysqli_fetch_array($data)) {
		...
		//cek jenis posting
		if ($jen == "forum") {
			header("location:forum.php?id_posting=$id_posting");
		}
						...
						<span class='badge text-black-50 mb-n2 mx-n1'><i class='fa fa-tag'></i><small>" . $tags[$t] . "</small></span>
							...
							<div class="clearfix">
								<div class="pull-right">
									<?php
									if ($akses == "publik") {
										echo "<span class='badge badge-success'><i class='fa fa-arrow-up'></i>&nbsp;Publik</span>&nbsp;";
									} elseif ($akses == "internal") {
										echo "<span class='badge badge-warning'><i class='fa fa-arrow-down'></i>&nbsp;Internal</span>&nbsp;";
									} else {
										echo "<span class='badge badge-danger'><i class='fa fa-ban'></i>&nbsp;Rahasia</span>&nbsp;";
									}
									/*
			  			if ($step==0){ 
       ...
       <hr class="bg-light shadow-lg">-->
												...
												<table>
													<tr>
														...
														<td>
															...
															<div class="d-flex justify-content-between mb-n2 ml-1">
															...
															<div class="card-text mb-n2 ml-2 overflow-hidden" id=<?php echo "isi_komentar" . $nourut ?>>
																<?php echo $dis['diskusi_isi']; ?>
															</div>
															<small class="text-muted ml-2"> <i><?php echo date('d-M-Y H:i', strtotime($dis['diskusi_tanggal'])) ?></i> &nbsp;</small>
														</td>
													</tr>
												</table>
			...
			<?php
			include 'footer.php';
			include 'assets_forum/footerForms.php';
			?>
