 <div class="col-lg-3">
 	...
 	while($d = mysqli_fetch_array($data)){
 		?>
 		<a class="btn btn1 btn-outline-danger btn-block" href="kategori_bymember.php?id=<?php echo $d['kategori_id']; ?>&id_member=<?php echo $id_member ?>&nama_member=<?php echo $nama_member ?>"><?php echo $d['kategori_nama']; ?></a>
 		<?php 
 	}
 	?>
